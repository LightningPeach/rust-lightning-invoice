...
{"lineNum":" 1907","line":"        assert!($size <= $dst.len());","class":"lineCov","hits":"2","order":"3570","possible_hits":"2",},
{"lineNum":" 1908","line":"        unsafe {"},
{"lineNum":" 1909","line":"            // N.B. https://github.com/rust-lang/rust/issues/22776"},
{"lineNum":" 1910","line":"            let bytes = *(&$n.$which() as *const _ as *const [u8; $size]);","class":"lineCov","hits":"2","order":"3571","possible_hits":"2",},
{"lineNum":" 1911","line":"            copy_nonoverlapping((&bytes).as_ptr(), $dst.as_mut_ptr(), $size);","class":"lineCov","hits":"4","order":"3572","possible_hits":"4",},
{"lineNum":" 1912","line":"        }"},
{"lineNum":" 1913","line":"    });"},
{"lineNum":" 1914","line":"}"},
{"lineNum":" 1915","line":""},
...
{"lineNum":" 1918","line":"        assert_eq!($src.len(), $size * $dst.len());","class":"linePartCov","hits":"2","order":"3409","possible_hits":"4",},
{"lineNum":" 1919","line":""},
{"lineNum":" 1920","line":"        unsafe {"},
{"lineNum":" 1921","line":"            copy_nonoverlapping(","class":"lineCov","hits":"1","order":"3417","possible_hits":"1",},
{"lineNum":" 1922","line":"                $src.as_ptr(),","class":"lineCov","hits":"1","order":"3414","possible_hits":"1",},
{"lineNum":" 1923","line":"                $dst.as_mut_ptr() as *mut u8,","class":"lineCov","hits":"1","order":"3415","possible_hits":"1",},
{"lineNum":" 1924","line":"                $src.len());","class":"lineCov","hits":"1","order":"3416","possible_hits":"1",},
{"lineNum":" 1925","line":"        }"},
{"lineNum":" 1926","line":"        for v in $dst.iter_mut() {","class":"lineCov","hits":"3","order":"3418","possible_hits":"3",},
{"lineNum":" 1927","line":"            *v = v.$which();","class":"lineCov","hits":"2","order":"3446","possible_hits":"2",},
{"lineNum":" 1928","line":"        }"},
{"lineNum":" 1929","line":"    }};"},
{"lineNum":" 1930","line":"}"},
{"lineNum":" 1931","line":""},
...
{"lineNum":" 1934","line":"        assert!($size == ::core::mem::size_of::<$ty>());"},
{"lineNum":" 1935","line":"        assert_eq!($size * $src.len(), $dst.len());"},
{"lineNum":" 1936","line":""},
{"lineNum":" 1937","line":"        unsafe {"},
{"lineNum":" 1938","line":"            copy_nonoverlapping("},
{"lineNum":" 1939","line":"                $src.as_ptr() as *const u8,"},
{"lineNum":" 1940","line":"                $dst.as_mut_ptr(),"},
{"lineNum":" 1941","line":"                $dst.len());"},
{"lineNum":" 1942","line":"        }"},
{"lineNum":" 1943","line":"    }};"},
{"lineNum":" 1944","line":"}"},
{"lineNum":" 1945","line":""},
...
{"lineNum":" 1948","line":"        assert!($size == ::core::mem::size_of::<$ty>());","class":"lineCov","hits":"1","order":"3582","possible_hits":"1",},
{"lineNum":" 1949","line":"        assert_eq!($size * $src.len(), $dst.len());","class":"linePartCov","hits":"2","order":"3584","possible_hits":"4",},
{"lineNum":" 1950","line":""},
{"lineNum":" 1951","line":"        for (&n, chunk) in $src.iter().zip($dst.chunks_mut($size)) {","class":"lineCov","hits":"4","order":"3585","possible_hits":"4",},
{"lineNum":" 1952","line":"            $write(chunk, n);","class":"lineCov","hits":"1","order":"3635","possible_hits":"1",},
{"lineNum":" 1953","line":"        }"},
{"lineNum":" 1954","line":"    });"},
{"lineNum":" 1955","line":"}"},
{"lineNum":" 1956","line":""},
...
{"lineNum":" 2010","line":"    fn write_u32(buf: &mut [u8], n: u32) {","class":"lineCov","hits":"1","order":"3636","possible_hits":"1",},
{"lineNum":" 2011","line":"        write_num_bytes!(u32, 4, n, buf, to_be);","class":"lineCov","hits":"3","order":"3637","possible_hits":"3",},
{"lineNum":" 2012","line":"    }","class":"linePartCov","hits":"1","order":"3638","possible_hits":"2",},
{"lineNum":" 2013","line":""},
{"lineNum":" 2014","line":"    #[inline]"},
{"lineNum":" 2015","line":"    fn write_u64(buf: &mut [u8], n: u64) {","class":"lineCov","hits":"1","order":"3568","possible_hits":"1",},
{"lineNum":" 2016","line":"        write_num_bytes!(u64, 8, n, buf, to_be);","class":"lineCov","hits":"3","order":"3569","possible_hits":"3",},
{"lineNum":" 2017","line":"    }","class":"linePartCov","hits":"1","order":"3573","possible_hits":"2",},
{"lineNum":" 2018","line":""},
...
{"lineNum":" 2058","line":"    fn read_u32_into(src: &[u8], dst: &mut [u32]) {","class":"lineCov","hits":"1","order":"3406","possible_hits":"1",},
{"lineNum":" 2059","line":"        read_slice!(src, dst, 4, to_be);","class":"lineCov","hits":"6","order":"3407","possible_hits":"6",},
{"lineNum":" 2060","line":"    }","class":"linePartCov","hits":"1","order":"3458","possible_hits":"2",},
{"lineNum":" 2061","line":""},
...
{"lineNum":" 2083","line":"    fn write_u32_into(src: &[u32], dst: &mut [u8]) {","class":"lineCov","hits":"1","order":"3581","possible_hits":"1",},
{"lineNum":" 2084","line":"        if cfg!(target_endian = \"big\") {"},
{"lineNum":" 2085","line":"            write_slice_native!(src, dst, u32, 4);"},
{"lineNum":" 2086","line":"        } else {"},
{"lineNum":" 2087","line":"            write_slice!(src, dst, u32, 4, Self::write_u32);","class":"lineCov","hits":"4","order":"3583","possible_hits":"4",},
{"lineNum":" 2088","line":"        }"},
{"lineNum":" 2089","line":"    }","class":"linePartCov","hits":"1","order":"3642","possible_hits":"2",},
{"lineNum":" 2090","line":""},
...
var header = { "command" : "lightning_invoice-df7259e68a5ae463", "date" : "2019-06-30 10:20:19", "instrumented" : 26, "covered" : 26,};
var merged_data = [];
