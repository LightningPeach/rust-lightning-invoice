...
{"lineNum":"   42","line":"    fn from_hex(s: &str) -> Result<Self, Error> {","class":"linePartCov","hits":"1","order":"2752","possible_hits":"2",},
{"lineNum":"   43","line":"        if s.len() != 2 * Self::LEN {","class":"linePartCov","hits":"2","order":"2753","possible_hits":"3",},
{"lineNum":"   44","line":"            return Err(Error::InvalidLength(2 * Self::LEN, s.len()));","class":"lineNoCov","hits":"0","possible_hits":"3",},
{"lineNum":"   45","line":"        }"},
{"lineNum":"   46","line":""},
{"lineNum":"   47","line":"        let mut vec = Vec::<u8>::from_hex(s)?;","class":"linePartCov","hits":"2","order":"2757","possible_hits":"4",},
{"lineNum":"   48","line":"        if Self::DISPLAY_BACKWARD {","class":"linePartCov","hits":"1","order":"2846","possible_hits":"2",},
{"lineNum":"   49","line":"            vec.reverse();","class":"lineNoCov","hits":"0","possible_hits":"1",},
{"lineNum":"   50","line":"        }"},
{"lineNum":"   51","line":"        Self::from_slice(&vec)","class":"lineCov","hits":"1","order":"2847","possible_hits":"1",},
{"lineNum":"   52","line":"    }","class":"linePartCov","hits":"2","order":"2854","possible_hits":"4",},
{"lineNum":"   53","line":"}"},
{"lineNum":"   54","line":""},
...
{"lineNum":"   63","line":""},
{"lineNum":"   64","line":"    fn next(&mut self) -> Option<Result<u8, Error>> {","class":"lineCov","hits":"1","order":"2764","possible_hits":"1",},
{"lineNum":"   65","line":"        if self.sl.len() % 2 == 1 {","class":"linePartCov","hits":"2","order":"2765","possible_hits":"3",},
{"lineNum":"   66","line":"            Some(Err(Error::OddLengthString(self.sl.len())))","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"   67","line":"        } else if self.sl.is_empty() {","class":"lineCov","hits":"3","order":"2766","possible_hits":"3",},
{"lineNum":"   68","line":"            None","class":"lineCov","hits":"1","order":"2843","possible_hits":"1",},
{"lineNum":"   69","line":"        } else {"},
{"lineNum":"   70","line":"            let (hi, lo) = {","class":"lineCov","hits":"1","order":"2803","possible_hits":"1",},
{"lineNum":"   71","line":"                let mut iter = self.sl.chars();","class":"lineCov","hits":"1","order":"2770","possible_hits":"1",},
{"lineNum":"   72","line":"                let hi = iter.next().unwrap();","class":"lineCov","hits":"1","order":"2774","possible_hits":"1",},
{"lineNum":"   73","line":"                let lo = iter.next().unwrap();","class":"lineCov","hits":"1","order":"2793","possible_hits":"1",},
{"lineNum":"   74","line":"                match (hi.to_digit(16), lo.to_digit(16)) {","class":"linePartCov","hits":"1","order":"2794","possible_hits":"2",},
{"lineNum":"   75","line":"                    (Some(hi), Some(lo)) => (hi, lo),","class":"lineCov","hits":"2","order":"2802","possible_hits":"2",},
...
{"lineNum":"   78","line":"                }"},
{"lineNum":"   79","line":"            };"},
{"lineNum":"   80","line":"            let ret = (hi << 4) + lo;","class":"linePartCov","hits":"2","order":"2804","possible_hits":"4",},
{"lineNum":"   81","line":"            self.sl = &self.sl[2..];","class":"lineCov","hits":"1","order":"2805","possible_hits":"1",},
{"lineNum":"   82","line":"            Some(Ok(ret as u8))","class":"lineCov","hits":"1","order":"2840","possible_hits":"1",},
{"lineNum":"   83","line":"        }"},
{"lineNum":"   84","line":"    }","class":"linePartCov","hits":"2","order":"2841","possible_hits":"3",},
{"lineNum":"   85","line":"}"},
{"lineNum":"   86","line":""},
...
{"lineNum":"  114","line":"    fn from_hex(s: &str) -> Result<Vec<u8>, Error> {","class":"linePartCov","hits":"1","order":"2758","possible_hits":"2",},
{"lineNum":"  115","line":"        if s.len() % 2 == 1 {","class":"lineCov","hits":"2","order":"2759","possible_hits":"2",},
{"lineNum":"  116","line":"            return Err(Error::OddLengthString(s.len()));","class":"lineNoCov","hits":"0","possible_hits":"2",},
{"lineNum":"  117","line":"        }"},
{"lineNum":"  118","line":""},
{"lineNum":"  119","line":"        let mut vec = Vec::with_capacity(s.len() / 2);","class":"lineCov","hits":"2","order":"2760","possible_hits":"2",},
{"lineNum":"  120","line":"        let iter = HexIterator {","class":"lineCov","hits":"1","order":"2762","possible_hits":"1",},
{"lineNum":"  121","line":"            sl: s","class":"lineCov","hits":"1","order":"2761","possible_hits":"1",},
{"lineNum":"  122","line":"        };"},
{"lineNum":"  123","line":"        for byte in iter {","class":"lineCov","hits":"4","order":"2763","possible_hits":"4",},
{"lineNum":"  124","line":"            vec.push(byte?);","class":"linePartCov","hits":"2","order":"2842","possible_hits":"3",},
{"lineNum":"  125","line":"        }"},
{"lineNum":"  126","line":"        Ok(vec)","class":"lineCov","hits":"1","order":"2844","possible_hits":"1",},
{"lineNum":"  127","line":"    }","class":"linePartCov","hits":"2","order":"2845","possible_hits":"5",},
{"lineNum":"  128","line":"}"},
{"lineNum":"  129","line":""},
...
var header = { "command" : "lightning_invoice-df7259e68a5ae463", "date" : "2019-06-30 10:20:19", "instrumented" : 45, "covered" : 29,};
var merged_data = [];
